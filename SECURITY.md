...
This module is pre-1.0. Only the latest version published on
[pkg.go.dev](https://pkg.go.dev/github.com/pilgrimagesoftware/dtrpg-sdk.go) receives security fixes.
...
[Security Advisories](https://github.com/pilgrimagesoftware/dtrpg-sdk.go/security/advisories/new). This
...
This policy covers the `dtrpg-sdk.go` Go module and its published GitHub Actions workflows. Vulnerabilities
in dependencies should be reported upstream; if a dependency issue affects this module directly (e.g. no
