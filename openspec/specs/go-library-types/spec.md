# go-library-types Specification

## Purpose
Define the Go model types for the library API's JSON:API-shaped resources, tracking the
upstream API contract's fields and optionality.
