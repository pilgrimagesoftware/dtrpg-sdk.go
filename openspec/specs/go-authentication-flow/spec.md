# go-authentication-flow Specification

## Purpose
Define how the Go SDK wraps authentication around API access so callers get predictable
Go-facing behavior without redefining the meaning of the API contract.
